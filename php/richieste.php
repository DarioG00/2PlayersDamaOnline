...
<head>
  ...
  <title>2playersDama Online - Richieste </title>
...
<body>
  ...
  <div class="container">
    ...
    <main id="richieste">
        <section>
          <h2>Richieste d'amicizia</h2>

          <?php
            //Otteniamo gli amici in sospeso dell'utente loggato
              $query = "SELECT mittente 
                        FROM guidi_607453.amicizia
                        WHERE destinatario = ? AND stato = 'sospesa'";
              ...
              if(mysqli_stmt_execute($statement)){
                ...
                while(mysqli_stmt_fetch($statement)){
                  ...
                  echo "<div class='richiesta'>
                          <p><i>".$mittente."</i> ti ha chiesto di aggiungerti come amico.</p>
                          <form method='POST' action='./rispondiRichiesta.php' class='pad'>
